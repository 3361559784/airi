...
export function createDryRunExecutor(config: ComputerUseConfig): DesktopExecutor {
  ...
  return {
    ...
    movePointer: async (_input: MovePointerActionInput & { pointerTrace: PointerTracePoint[] }) => result(['dry-run: pointer not moved'], executionTarget),
    mouseButton: async (_input: MouseButtonActionInput & { pointerTrace: PointerTracePoint[] }) => result(['dry-run: mouse button not injected'], executionTarget),
    longPress: async (_input: LongPressActionInput & { pointerTrace: PointerTracePoint[] }) => result(['dry-run: long press not injected'], executionTarget),
    dragPointer: async (_input: DragPointerActionInput & { approachTrace: PointerTracePoint[], dragTrace: PointerTracePoint[] }) => result(['dry-run: drag not injected'], executionTarget),
